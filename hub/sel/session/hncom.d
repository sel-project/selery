...
class HncomHandler : HandlerThread {
	...
	public this(shared Server server, shared JSONValue* additionalJson) {
		string ip = "::";
...
abstract class AbstractNode : Session, Handler!serverbound {
	...
	public shared this(shared Server server, shared JSONValue* additionalJson) {
		super(server);
		this.additionalJson = additionalJson;
	}
...
class ClassicNode : AbstractNode {
	...
	public shared this(shared Server server, Socket socket, shared JSONValue* additionalJson) {
